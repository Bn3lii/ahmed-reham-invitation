...
export default function RevealSection() {
  ...
  return (
    <section ref={sectionRef} className="min-h-screen flex flex-col items-center justify-center py-8 px-8 bg-secondary relative overflow-hidden">
      ...
      <div className={`absolute bottom-6 left-0 right-0 flex justify-center animate-bounce z-10 transition-opacity duration-1000 delay-1000 ${revealedCount === 3 ? "opacity-100" : "opacity-0 pointer-events-none"
        }`}>
